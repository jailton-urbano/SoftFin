...
namespace SoftFin.Sefaz
{
    ...
    public class NFeCancelamento
    {
        ...
        private XmlDocument GeraXMLNFSe(DTOLogEvento dTOEvento, System.Security.Cryptography.X509Certificates.X509Certificate2 cert)
        {
            ...
            AdicionaNovoAtributo(xmlDocument, nodeinfEvento, "Id", "ID110111" + dTOEvento.chNFe + "0" + dTOEvento.nSeqEvento);
            ...
            AdicionaNovoNode(xmlDocument, nodeinfEvento, "tpEvento", dTOEvento.tpEvento);
            ...
            AdicionaNovoNode(xmlDocument, nodedetEvento, "descEvento", dTOEvento.descEvento);
            AdicionaNovoNode(xmlDocument, nodedetEvento, "nProt", dTOEvento.nProt);
            AdicionaNovoNode(xmlDocument, nodedetEvento, "xJust", dTOEvento.xJust);
