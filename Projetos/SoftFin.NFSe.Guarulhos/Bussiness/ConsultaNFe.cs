    ...
    public class ConsultaNFe
    {
        ...
        public XmlDocument AplicaAssinatura2(XmlDocument docXML, string uri, X509Certificate2 cert)
        {
            try
            {
                ...
                //XmlAttributeCollection _Uri = docXML.GetElementsByTagName("ConsultarNfseRpsEnvio").Item(0).Attributes;
        ...
        private DTORetornoNFEs Processar(DTONotaFiscal pedidoConsultaNFe, X509Certificate2 certificadoPrestador)
        {
            ...
            //                    nfes, "ConsultarNfseRpsEnvio", "ConsultarNfseRpsEnvio", certificadoPrestador);

            retornoAssinado = AplicaAssinatura2(retornoAssinado, "ConsultarNfseRpsEnvio", certificadoPrestador);

            //retornoAssinado.Save("c:\\lixo\\nfConsultaGuarulhos.xml");
        ...
        private XmlDocument GeraXMLNFSe(DTONotaFiscal pedidoConsultaNFe, X509Certificate2 certificadoPrestador)
        {
            ...
            XmlNode nodePrincipal = xmlDocument.CreateElement("ConsultarNfseRpsEnvio");
            ...
            attribute3.Value = "http://www.ginfes.com.br/servico_consultar_nfse_rps_envio_v03.xsd";
            ...
            var nodeIdentificacaoRps = xmlDocument.CreateElement("IdentificacaoRps");
            nodePrincipal.AppendChild(nodeIdentificacaoRps);

            PreecheNode(xmlDocument, nodeIdentificacaoRps, "Numero", pedidoConsultaNFe.NFSe.FirstOrDefault().ChaveRPS.NumeroRPS, "tipos");
            PreecheNode(xmlDocument, nodeIdentificacaoRps, "Serie", pedidoConsultaNFe.NFSe.FirstOrDefault().ChaveRPS.SerieRPS, "tipos");
            PreecheNode(xmlDocument, nodeIdentificacaoRps, "Tipo", "1", "tipos");
