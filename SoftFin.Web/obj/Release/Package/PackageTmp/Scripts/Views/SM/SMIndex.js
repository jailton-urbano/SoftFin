...
app.controller('MestreEntidade', [
    '$scope', '$http', '$location', '$anchorScroll', '$timeout', '$modal', function ($scope, $http, $location, $anchorScroll, $timeout, $modal) {
        ...
        $scope.ObterTodos = function () {
            ...
            $http.post("../../SM/ObterTodos/", $scope.Filter)
                .success(function (data) {
                    $scope.listaDados = data;
                    Metronic.unblockUI();
                }).error(function (data) {
        ...
        $scope.ObterPorId = function (value) {
            ...
            $http.post("../../SM/ObterPorId", { id: value })
                .success(function (data) {
        ...
        $scope.Salvar = function () {
            ...
            $http.post("../../SM/Salvar", $scope.entidade)
                .success(function (data) {
                    Metronic.unblockUI();
...
var ControllerExcluir = function ($scope, $modalInstance, $modal, $http, $timeout, item) {
    ...
    $scope.OK = function () {
        ...
        $http.post("../../SM/Excluir", { obj: $scope.entidade })
            .success(function (data) {
                Metronic.unblockUI();
                if (data.CDStatus === "OK") {
