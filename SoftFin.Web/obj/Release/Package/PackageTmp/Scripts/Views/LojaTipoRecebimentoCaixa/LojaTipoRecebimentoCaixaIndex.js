...
app.controller('MestreEntidade', [
    '$scope', '$http', '$location', '$anchorScroll', '$timeout', '$modal', function ($scope, $http, $location, $anchorScroll, $timeout, $modal) {
        ...
        $http.post("../../LojaTipoRecebimentoCaixa/AcessoEdicao")
        ...
        $scope.ObterTodos = function () {
            ...
            $http.post("../../LojaTipoRecebimentoCaixa/ObterTodos/")
            .success(function (data) {
                $scope.lista = data;
                Metronic.unblockUI();
            }).error(function (data) {
        ...
        $scope.Salvar = function () {
            ...
            $http.post("../../LojaTipoRecebimentoCaixa/Salvar", $scope.entidade)
            .success(function (data) {
                Metronic.unblockUI();
        ...
        $scope.ObterPorId = function (value) {
            ...
            $http.post("../../LojaTipoRecebimentoCaixa/ObterPorId", { id: value })
            .success(function (data) {
        ...
        $scope.Excluir = function (item) {
            ...
            $http.post("../../LojaOperador/ObterLoja")
                .success(function (data) {
                    Metronic.unblockUI();
            ...
            $scope.LoadLoja = function () {
                ...
                $http.post("../../LojaTipoRecebimentoCaixa/ObterLoja")
                    .success(function (data) {
                        Metronic.unblockUI();
                        $scope.ListaLoja = data;
                    }).error(function (data) {
            ...
            $scope.LoadBanco = function () {
                ...
                $http.post("../../LojaTipoRecebimentoCaixa/ObterBanco")
                    .success(function (data) {
                        Metronic.unblockUI();
            ...
            $scope.NovoItem = function () {
                $scope.entidade.vigencias.push({ id: 0, deleted: false});
            };
            $scope.LoadLoja();
            $scope.LoadBanco();
            $scope.ObterTodos();
...
var ControllerExcluir = function ($scope, $modalInstance, $modal, $http, $timeout, item) {
    ...
    $scope.ok = function () {
        $http.post("../../LojaTipoRecebimentoCaixa/Excluir", { obj: $scope.item })
        .success(function (data) {
            if (data.CDStatus == "OK") {
