...
app.controller('MestreEntidade', [
    '$scope', '$http', '$location', '$anchorScroll', '$timeout', '$modal', function ($scope, $http, $location, $anchorScroll, $timeout, $modal) {
        ...
        $http.post("../../LojaOperador/AcessoEdicao")
        ...
        $scope.ObterTodos = function () {
            ...
            $http.post("../../LojaOperador/ObterTodos/")
            .success(function (data) {
                $scope.lista = data;
                Metronic.unblockUI();
            }).error(function (data) {
        ...
        $scope.Salvar = function () {
            ...
            $http.post("../../LojaOperador/Salvar", $scope.entidade)
            .success(function (data) {
                Metronic.unblockUI();
        ...
        $scope.ObterPorId = function (value) {
            ...
            $http.post("../../LojaOperador/ObterPorId", { id: value })
            .success(function (data) {
...
var ControllerExcluir = function ($scope, $modalInstance, $modal, $http, $timeout, item) {
    ...
    $scope.ok = function () {
        $http.post("../../LojaOperador/Excluir", { obj: $scope.item })
        .success(function (data) {
            if (data.CDStatus == "OK") {
