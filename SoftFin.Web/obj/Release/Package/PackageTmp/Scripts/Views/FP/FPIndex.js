...
app.controller('MestreEntidade', [
    '$scope', '$http', '$location', '$anchorScroll', '$timeout', '$modal', function ($scope, $http, $location, $anchorScroll, $timeout, $modal) {
        ...
        $scope.Salvar = function () {
            ...
            $http.post("../../FP/Salvar", $scope.entidade)
            .success(function (data) {
                Metronic.unblockUI();
        ...
        $scope.ObterPorId = function (value) {
            ...
            $http.post("../../FP/ObterPorId", { id: value })
            .success(function (data) {
        ...
        $scope.LoadFuncionario = function () {
            $http.post("../../FP/ObterFuncionarios/")
            .success(function (data) {
        ...
        $scope.LoadFolhaPagamentoTipo = function () {
            $http.post("../../FP/ObterFolhaPagamentoTipo/")
            .success(function (data) {
                $scope.listaFolhaPagamentoTipo = data;
            }).error(function (data) {
                $scope.MsgError("Sistema indisponivel");
            });
        }
...
var ControllerExcluir = function ($scope, $modalInstance, $modal, $http, $timeout, item) {
    ...
    $scope.ok = function () {
        $http.post("../../FP/Excluir", { obj: $scope.item })
        .success(function (data) {
            if (data.CDStatus == "OK") {
