...
(function (angular) {
    ...
    (function () {
        ...
        .directive('uiDateMask', ['$locale', '$log', function ($locale, $log) {
            ...
            var dateFormat = dateFormatMapByLocalle[$locale.id] || 'DD/MM/YYYY';
                ...
                link: function (scope, element, attrs, ctrl) {
                    ...
                    function applyMask(value) {
                        ...
                        if (formatedValue != undefined) {
                            retorno = formatedValue.trim().replace(/[^0-9]$/, '');
                        }
            ...
            .directive('uiDateMaskMonthYear', ['$locale', '$log', function ($locale, $log) {
        ...
        .directive('uiDateTimeMask', ['$locale', '$log', function ($locale, $log) {
            if (typeof moment === 'undefined') {
                throw new Error('Moment.js not found. Check if it is available.');
            }
            ...
            var dateFormat = dateFormatMapByLocalle[$locale.id] || 'DD/MM/YYYY hh:mm';

            return {
                restrict: 'A',
                require: '?ngModel',
                link: function (scope, element, attrs, ctrl) {
                    var dateMask = new StringMask(dateFormat.replace(/[YMDhm]/g, '0'));
        ...
        .directive('uiPeriodoMask', ['$locale', '$log', function ($locale, $log) {
            if (typeof moment === 'undefined') {
                throw new Error('Moment.js not found. Check if it is available.');
            }
            ...
            var dateFormat = dateFormatMapByLocalle[$locale.id] || 'MM/YYYY';
