...
app.controller('MestreEntidade', [
    '$scope', '$http', '$location', '$anchorScroll', '$timeout', '$modal', function ($scope, $http, $location, $anchorScroll, $timeout, $modal) {
        ...
        $http.post("../../LojaCaixa/AcessoEdicao")
        ...
        $scope.ObterTodos = function () {
            ...
            $http.post("../../LojaCaixa/ObterTodos/")
            .success(function (data) {
                $scope.lista = data;
                Metronic.unblockUI();
            }).error(function (data) {
        ...
        $scope.Salvar = function () {
            ...
            $http.post("../../LojaCaixa/Salvar", $scope.entidade)
            .success(function (data) {
                Metronic.unblockUI();
        ...
        $scope.ObterPorId = function (value) {
            ...
            $http.post("../../LojaCaixa/ObterPorId", { id: value })
            .success(function (data) {
...
var ControllerExcluir = function ($scope, $modalInstance, $modal, $http, $timeout, item) {
    ...
    $scope.ok = function () {
        $http.post("../../LojaCaixa/Excluir", { obj: $scope.item })
        .success(function (data) {
            if (data.CDStatus == "OK") {
