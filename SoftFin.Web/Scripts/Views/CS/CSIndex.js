...
app.controller('MestreEntidade', [
    '$scope', '$http', '$location', '$anchorScroll', '$timeout', '$modal', function ($scope, $http, $location, $anchorScroll, $timeout, $modal) {
        ...
        $scope.Salvar = function () {
            ...
            $http.post("../../CS/Salvar", $scope.entidade)
            .success(function (data) {
                Metronic.unblockUI();
        ...
        $scope.ObterPorId = function (value) {
            ...
            $http.post("../../CS/ObterPorId", { id: value })
            .success(function (data) {
        ...
        $scope.LoadCodigoServicoMunicipio = function () {
            $http.post("../../CS/ObterCodigoServicoMunicipio")
                .success(function (data) {
        ...
        $scope.ObterTodos();
        $scope.LoadCodigoServicoMunicipio();
    }]);
...
var ControllerExcluir = function ($scope, $modalInstance, $modal, $http, $timeout, item) {
    ...
    $scope.ok = function () {
        ...
        $http.post("../../CS/Excluir", { obj: $scope.item })
        .success(function (data) {
            Metronic.unblockUI();
            if (data.CDStatus == "OK") {
