...
app.controller('MestreEntidade', [
    '$scope', '$http', '$location', '$anchorScroll', '$timeout', '$modal', function ($scope, $http, $location, $anchorScroll, $timeout, $modal) {
        ...
        $scope.ObterTodos = function () {
            ...
            $http.post("../../TH/ObterTodos/", $scope.Filter)
                .success(function (data) {
                    $scope.listProjetoAtividades = data;
                    Metronic.unblockUI();
                }).error(function (data) {
        ...
        $scope.ObterCategoriaProfissional = function () {
            Metronic.blockUI({
                boxed: true
            });

            $http.post("../../TH/ObterCategoriaProfissional/", $scope.Filter)
                .success(function (data) {
        ...
        $scope.ObterCategoriaProfissional();
        ...
        $scope.ObterPorId = function (value) {
            ...
            $http.post("../../TH/ObterPorId", { id: value })
                .success(function (data) {
        ...
        $scope.Salvar = function () {
            ...
            $http.post("../../TH/Salvar", $scope.entidade)
                .success(function (data) {
                    Metronic.unblockUI();
...
var ControllerExcluir = function ($scope, $modalInstance, $modal, $http, $timeout, item) {
    ...
    $scope.OK = function () {
        ...
        $http.post("../../TH/Excluir", { obj: $scope.entidade })
            .success(function (data) {
                Metronic.unblockUI();
                if (data.CDStatus === "OK") {
