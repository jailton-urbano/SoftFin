...
app.controller('MestreEntidade', [
    '$scope', '$http', '$location', '$anchorScroll', '$timeout', '$modal', function ($scope, $http, $location, $anchorScroll, $timeout, $modal) {
        ...
        $scope.ObterTodos = function () {
            ...
            $http.post("../../SDB/ObterTodos/", $scope.Filter)
        ...
        $scope.ObterPorId = function (value) {
            ...
            $http.post("../../SDB/ObterPorId", { id: value })
                .success(function (data) {
        ...
        $scope.Salvar = function () {
            ...
            $http.post("../../SDB/Salvar", $scope.entidade)
                .success(function (data) {
                    Metronic.unblockUI();
        ...
        $scope.LoadSistemaMenu = function () {
            $http.post("../../SDB/ObterSistemaMenu/")
                .success(function (data) {
                    $scope.listSistemaMenu = data;
                }).error(function (data) {
                    $scope.MsgError("Sistema indisponivel");
                });
        };

        $scope.LoadSistemaMenu();
...
var ControllerExcluir = function ($scope, $modalInstance, $modal, $http, $timeout, item) {
    ...
    $scope.OK = function () {
        ...
        $http.post("../../SDB/Excluir", { obj: $scope.entidade })
            .success(function (data) {
                Metronic.unblockUI();
                if (data.CDStatus === "OK") {
