...
app.controller('MestreEntidade', [
    '$scope', '$http', '$location', '$anchorScroll', '$timeout', '$modal', function ($scope, $http, $location, $anchorScroll, $timeout, $modal) {
        ...
        $scope.ObterTodos = function () {
            ...
            $http.post("../../SDBF/ObterTodos/", $scope.Filter)
                .success(function (data) {
                    $scope.listSistemas = data;
                    Metronic.unblockUI();
                }).error(function (data) {
                    $scope.MsgError("Sistema indisponivel");
                    Metronic.unblockUI();
        ...
        $scope.ObterPorId = function (value) {
            ...
            $http.post("../../SDBF/ObterPorId", { id: value })
                .success(function (data) {
        ...
        $scope.Salvar = function () {
            ...
            $http.post("../../SDBF/Salvar", $scope.entidade)
                .success(function (data) {
                    Metronic.unblockUI();
        ...
        $scope.LoadFuncionalidade = function () {
            $http.post("../../SDBF/ObterFuncionalidade/")
                .success(function (data) {
                    $scope.listFuncionalidades = data;
                }).error(function (data) {
                    $scope.MsgError("Sistema indisponivel");
                });
        };

        $scope.LoadFuncionalidade();

        

        $scope.LoadSistemaDashBoard = function () {
            $http.post("../../SDBF/ObterSistemaDashBoard/")
                .success(function (data) {
                    $scope.listSistemaDashBoard = data;
                }).error(function (data) {
                    $scope.MsgError("Sistema indisponivel");
                });
        };

        $scope.LoadSistemaDashBoard();
...
var ControllerExcluir = function ($scope, $modalInstance, $modal, $http, $timeout, item) {
    ...
    $scope.OK = function () {
        ...
        $http.post("../../SDBF/Excluir", { obj: $scope.entidade })
            .success(function (data) {
                Metronic.unblockUI();
                if (data.CDStatus === "OK") {
