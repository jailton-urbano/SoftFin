...
{
    public class AtendimentoCategoriaController : BaseController
    {
        public ActionResult Excel()
        {
            var obj = new AtendimentoCategoria();
            ...
            return File(myCsvData, "application/vnd.ms-excel", "AtendimentoCategoria.csv");
        }
        ...
        public ActionResult Listas(JqGridRequest request)
        {
            ...
            int totalRecords = 0;
            AtendimentoCategoria obj = new AtendimentoCategoria();
            var objs = new AtendimentoCategoria().ObterTodos(_paramBase);
        ...
        public ActionResult Create(AtendimentoCategoria obj)
        {
            try
            {
                //CarregaViewData();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(AtendimentoCategoria obj)
        {
            try
            {
            CarregaViewData();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(AtendimentoCategoria obj)
        {
            try
            {
            CarregaViewData();
