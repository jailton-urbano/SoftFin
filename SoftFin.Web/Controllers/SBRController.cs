...
{
    public class SBRController : BaseController
    {
        // GET: SBR
        ...
        public JsonResult ObterTodos()
        {
            ...
            return Json(objs.Select(p => new
            {
                p.id,
                p.banco_id,
                dataSaldo =  p.dataSaldo.ToString("o"),
                p.Banco.nomeBanco
        ...
        {
            var p = new SaldoBancarioReal().ObterPorId(id, _paramBase);
            if (p == null)
            {
                p = new SaldoBancarioReal();
            }
        ...
        public ActionResult Salvar(SaldoBancarioReal obj)
        {
            try
            {
        ...
        public JsonResult Excluir(SaldoBancarioReal obj)
        {
