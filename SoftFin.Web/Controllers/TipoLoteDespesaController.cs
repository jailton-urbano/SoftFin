...
{
    public class TipoLoteDespesaController : BaseController
    {
        public ActionResult Excel()
        {
            var obj = new TipoLoteDespesa();
        ...
        public ActionResult Listas(JqGridRequest request)
        {
            ...
            int totalRecords = 0;
            TipoLoteDespesa obj = new TipoLoteDespesa();
            var objs = new TipoLoteDespesa().ObterTodos(_paramBase);
        ...
        public ActionResult Create(TipoLoteDespesa obj)
        {
            try
            {
                CarregaViewData();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(TipoLoteDespesa obj)
        {
            try
            {
                CarregaViewData();
        ...
        [HttpPost]
        public ActionResult Delete(TipoLoteDespesa obj)
        {
            try
            {
                CarregaViewData();
